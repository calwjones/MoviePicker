...
export default function MatchStrikeLoader({ size = 160, className = '', label = 'Loading' }: Props) {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id={id('msl-flame')} x1="0.5" y1="0" x2="0.5" y2="1">
          <stop offset="0" stopColor="#FFE7B0" />
          <stop offset="0.45" stopColor="#FF8A1F" />
          <stop offset="1" stopColor="#A12F0A" />
        </linearGradient>
        <linearGradient id={id('msl-flame-core')} x1="0.5" y1="0" x2="0.5" y2="1">
        ...
        <linearGradient id={id('msl-stick')} x1="0" y1="0" x2="1" y2="0">
          <stop offset="0" stopColor="#8C7F6E" />
          <stop offset="0.5" stopColor="#F0E6D3" />
          <stop offset="1" stopColor="#6E6354" />
        </linearGradient>
        <radialGradient id={id('msl-head')} cx="0.4" cy="0.35" r="0.75">
          <stop offset="0" stopColor="#E25A2E" />
          <stop offset="0.55" stopColor="#A12F0A" />
          <stop offset="1" stopColor="#3D1004" />
        </radialGradient>
        <radialGradient id={id('msl-glow')} cx="0.5" cy="0.5" r="0.5">
          <stop offset="0" stopColor="#FF8A1F" stopOpacity="0.4" />
          <stop offset="1" stopColor="#FF8A1F" stopOpacity="0" />
        </radialGradient>
        <linearGradient id={id('msl-box-body')} x1="0" y1="0" x2="0" y2="1">
          <stop offset="0" stopColor="#2A2A2A" />
          <stop offset="1" stopColor="#0F0F0F" />
        </linearGradient>
        <linearGradient id={id('msl-box-strip')} x1="0" y1="0" x2="0" y2="1">
          <stop offset="0" stopColor="#7A2308" />
          <stop offset="1" stopColor="#3D1004" />
        </linearGradient>
        <pattern id={id('msl-grit')} x="0" y="0" width="4" height="4" patternUnits="userSpaceOnUse">
      ...
      <g>
        {/* Box body */}
        <rect x="20" y="76" width="100" height="20" rx="2.5" fill={`url(#${id('msl-box-body')})`} />
        {/* Top edge highlight */}
        ...
        {/* Strike strip */}
        <rect x="24" y="78" width="92" height="6" rx="1" fill={`url(#${id('msl-box-strip')})`} />
        <rect x="24" y="78" width="92" height="6" rx="1" fill={`url(#${id('msl-grit')})`} />
      ...
      <g className="ms-match">
        ...
        <g className="ms-flame">
          <circle cx="0" cy="-12" r="16" fill={`url(#${id('msl-glow')})`} />
          {/* Flame outer */}
          <g className="ms-flame-core-wrap">
            ...
            <path
              d="M 0 -15
                 ...
                 C 2 5, 5 3, 5 -1
                 C 5 -5, 2 -10, 0 -15 Z"
              fill={`url(#${id('msl-flame-core')})`}
            />
          </g>
        </g>

        {/* Match head */}
        <ellipse cx="0" cy="0" rx="4.5" ry="6" fill={`url(#${id('msl-head')})`} />
        <ellipse cx="-1.5" cy="-2" rx="1.2" ry="1.8" fill="#F0865A" opacity="0.55" />

        {/* Stick — extends DOWN from head */}
        <rect x="-2" y="5" width="4" height="30" rx="1.2" fill={`url(#${id('msl-stick')})`} />
